...
# for mt-bench-tw
python gen_model_answer.py --model-path [MODEL-PATH] --model-id [MODEL-ID] --bench-name mt_bench_tw
```
Arguments:
...
export FAST_CHAT_AZ_OPENAI_API_KEY=
export FAST_CHAT_AZ_OPENAI_API_ENDPOINT=
export FAST_CHAT_AZ_OPENAI_API_VERSION=
export FAST_CHAT_AZ_OPENAI_MODEL=

# for mt-bench
python gen_judgment.py --model-list [LIST-OF-MODEL-ID] --parallel 8

# for mt-bench-tw
python gen_judgment.py --model-list [LIST-OF-MODEL-ID] --parallel 8 --judge-model human_w_gpt4_augmented --bench-name mt_bench_tw --judge-file data/judge_prompts_for_mt_bench_tw.jsonl
```
...
- Show the scores for selected models
  ...
  # for mt-bench-tw
  python show_result.py --model-list vicuna-13b-v1.3 alpaca-13b llama-13b claude-v1 gpt-3.5-turbo gpt-4 --input-file data/mt_bench_tw/model_judgment/human_w_gpt4_augmented_single.jsonl
  ```
- Show all scores
  ```
  # for mt-bench
  ...
  # for mt-bench-tw
  python show_result.py --input-file data/mt_bench_tw/model_judgment/human_w_gpt4_augmented_single.jsonl
  ```
